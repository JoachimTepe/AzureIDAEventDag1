...
$output = az storage account create --name "hickdag1storage" --resource-group "rg_joachimpetersen"

$output = az functionapp create --name "JoachimFunctionApp"  --resource-group "rg_joachimpetersen" --storage-account "hickdag1storage"
